...
const savedSeriesLanguages = sessionStorage.getItem('maMediatheque.activeSeriesLanguages');
let activeSeriesLanguages = savedSeriesLanguages ? new Set(JSON.parse(savedSeriesLanguages)) : new Set(languageOrder);
